...
class Rma182LifecycleHardeningTests(unittest.TestCase):
    def test_simulation_pause_resume_keeps_no_catch_up_invariant(self) -> None:
        ...
        runtime = read("Assets/ReachyMini/Runtime/Rendering/ReachyProductionAuthoritativeRuntime.cs")
    ...
    def test_one_application_lifecycle_ingress_coordinates_services_and_camera(self) -> None:
        host = read("Assets/ReachyMini/Runtime/Application/ReachyApplicationHostBehaviour.cs")
        contracts = read("Assets/ReachyMini/Runtime/Core/Application/ReachyApplicationInterruption.cs")
        camera = read("Assets/ReachyMini/Runtime/Application/ReachyAndroidCameraAcquisition.Lifecycle.cs")
    ...
    def test_camera_and_speech_release_or_cancel_active_resources(self) -> None:
        camera = read("Assets/ReachyMini/Runtime/Application/ReachyAndroidCameraAcquisition.Lifecycle.cs")
        speech = read("Assets/ReachyMini/Runtime/Core/Speech/SpeechAudioFocusCoordinator.Lifecycle.cs")
        coordinated_asr = read("Assets/ReachyMini/Runtime/Core/Speech/AudioCoordinatedAsrProvider.cs")
    ...
    def test_network_and_inference_jobs_are_generation_cancelled_not_restarted(self) -> None:
        http_core = read("Assets/ReachyMini/Runtime/Core/Providers/ReachySharedHttpTransport.Core.cs")
        http_lifecycle = read("Assets/ReachyMini/Runtime/Core/Providers/ReachySharedHttpTransport.Lifecycle.cs")
        llm = read("Assets/ReachyMini/Runtime/Core/LocalModels/ReachyLocalLlmProvider.Generation.cs")
        llm_lifecycle = read("Assets/ReachyMini/Runtime/Core/LocalModels/ReachyLocalLlmProvider.Lifecycle.cs")
    ...
    def test_conversation_and_ui_resume_to_defined_state_without_overwriting_errors(self) -> None:
        conversation = read("Assets/ReachyMini/Runtime/Core/Conversation/ReachyConversationStateMachine.Lifecycle.cs")
        ui = read("Assets/ReachyMini/Runtime/Core/Application/ReachyMainScreenState.Lifecycle.cs")
        production = read("Assets/ReachyMini/Runtime/Application/ReachyProductionApplicationCompositionProvider.cs")
        settings = read("Assets/ReachyMini/Runtime/Application/ReachySettingsApplicationCompositionProvider.cs")

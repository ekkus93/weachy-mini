...
- **Reachy Mini software** — Pollen Robotics / Hugging Face, generally Apache License 2.0 for software. Exact imported paths and revisions will be recorded by RMA-011.
- **Reachy Mini hardware/model assets** — Pollen Robotics, CC BY-NC-SA as identified by the upstream project. Redistribution is blocked until each asset's source and notice requirements are verified.
